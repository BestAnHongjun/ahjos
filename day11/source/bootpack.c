...
void HariMain(void)
{
	...
	init_palette();
	putfonts8_asc(binfo->vram, binfo->scrnx, 0, 32, COL8_FFFFFF, "Checking mem...");
	...
	// make_window8(buf_win, 160, 52, "count");
	make_window8(buf_win, 160, 68, "window");
	putfonts8_asc(buf_win, 160, 24, 28, COL8_000000, "Welcome to");
	putfonts8_asc(buf_win, 160, 24, 44, COL8_000000, "  AHJ-OS!");
	...
	for (;;) {
		...
		else 
		{
			...
			if (status_mouse <= 15)
			{
				...
				sheet_refresh(sht_back, 32, 16, 32 + 23 * 8, 32);
